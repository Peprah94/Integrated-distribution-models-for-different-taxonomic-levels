...
run_nimble_model <- function(simulations_all, method, covariance_prior, shared){
  #simulations_all is the simulated data
  # method : wheter IDM, IG, Spe
  # covariance prior: LV or full
  #shared : all, interractions, covariate_inter
  ...
  cmcmc <- compileNimble(Rmcmc, project = Cmwtc) 
