...
species_estimates_na <- pblapply(simulations_all_na[101:150], 
                                 function(x){run_nimble_model(x, method = "Spe", covariance_prior = "full", shared = "all")},
                                 cl=cl)

save(species_estimates_na, file="estimate_species_na1.RData")
stopCluster(cl)
